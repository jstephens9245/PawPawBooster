	...
	var Events = function Events(props) {
	  ...
	  if (props.events.length) {
	    sortedEventArray = props.events.sort(function (a, b) {
	      return Number([dateConverter(a['date']), timeConverter(a['time'])].join('.')) - Number([dateConverter(b['date']), timeConverter(b['time'])].join('.'));
	    });
...
//# sourceMappingURL=0.5b7b83d99517c3343f90.hot-update.js.map