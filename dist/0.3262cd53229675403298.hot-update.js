	...
	var EventContainer = exports.EventContainer = function (_Component) {
	  ...
	  _createClass(EventContainer, [{
	    ...
	    value: function submitForm(e) {
	      ...
	      e.preventDefault();
	      this.props.creatingEvent(this.state.date, this.state.time, this.state.title, this.state.description).then(function (result) {
...
//# sourceMappingURL=0.3262cd53229675403298.hot-update.js.map