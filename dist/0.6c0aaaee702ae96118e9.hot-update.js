	...
	var Events = function Events(props) {
	  ...
	  if (props.events.length) {
	    props.events.sort(function (a, b) {
	      var num = dateConverter(a['date']) - dateConverter(b['date']);
	      return num;
	    });
	    props.events.sort(function (a, b) {
	      var num = parseFloat(timeConverter(a['time'])) - parseFloat(timeConverter(b['time']));
...
//# sourceMappingURL=0.6c0aaaee702ae96118e9.hot-update.js.map