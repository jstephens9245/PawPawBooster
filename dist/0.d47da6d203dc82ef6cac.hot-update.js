	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    createEvent: function (_createEvent) {
	      function createEvent(_x, _x2, _x3, _x4) {
	      ...
	      return createEvent;
	    }(function (date, time, title, description) {
	      return dispatch(createEvent(date, time, title, description));
	    })
	  };
	};
...
//# sourceMappingURL=0.d47da6d203dc82ef6cac.hot-update.js.map